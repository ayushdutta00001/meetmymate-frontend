    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F2F4F7]">
        <div className="bg-white p-8 rounded-2xl shadow-md text-center max-w-md">
          ...
          <button
            onClick={signOut}
            className="px-6 py-3 rounded-xl bg-gradient-to-r from-[#3C82F6] to-[#3758FF] text-white"
          >
            Logout
          </button>
        </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F2F4F7] via-[#E8EBF0] to-[#F2F4F7] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="text-center mb-12">
          <h1 className="text-3xl mb-2">Welcome to Meet My Mate in in</h1>
