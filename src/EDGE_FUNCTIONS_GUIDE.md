# Meet my Mate in - Supabase Edge Functions Template

This directory contains templates for all Supabase Edge Functions needed for the Meet my Mate in platform.
