...
export function BusinessMeetupDisputes() {
    ...
    return (
      <div className="min-h-screen bg-gray-50 dark:bg-[#0A0F1F]">
        <div className="bg-white dark:bg-[#1A1F2E] border-b border-gray-200 dark:border-gray-800 px-8 py-6">
          <h1 className="text-2xl text-gray-900 dark:text-white">Business Meetup — Disputes & Reports</h1>
  ...
  const disputesMock: DisputeCase[] = [
    {
      id: 'D-BM-2031',
      bookingId: 'BM-7823',
      user1: { id: 'U-5421', name: 'Startup Founder A' },
      user2: { id: 'I-8912', name: 'Venture Capital Fund' },
      category: 'Misrepresentation',
      severity: 'High',
      status: 'Open',
      createdDate: '2024-12-27',
      assignedTo: 'Admin A',
      description: 'Investor claims startup misrepresented revenue figures during pitch meeting.'
    },
    {
      id: 'D-BM-2030',
      bookingId: 'BM-7820',
      user1: { id: 'U-3421', name: 'Marketing Manager' },
      user2: { id: 'E-7821', name: 'Industry Expert' },
      category: 'No-Show',
      severity: 'Medium',
      status: 'Under Review',
      createdDate: '2024-12-26',
      assignedTo: 'Admin B',
      description: 'Expert did not attend scheduled consultation meeting.'
    },
    {
      id: 'D-BM-2029',
      bookingId: 'BM-7818',
      user1: { id: 'U-9012', name: 'Business Owner' },
      user2: { id: 'P-5431', name: 'Peer Consultant' },
      category: 'Confidentiality Breach',
      severity: 'Critical',
      status: 'Escalated',
      createdDate: '2024-12-25',
      assignedTo: 'Admin C',
      description: 'User 1 alleges business strategy discussed in meeting was shared publicly by User 2.'
    },
  ];
        ...
        <div className="bg-white dark:bg-[#1A1F2E] rounded-lg border border-gray-200 dark:border-gray-800 p-4 mb-6">
          <div className="flex items-center gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Search by case ID, booking ID, or participant name..."
          ...
          <table className="w-full">
            <thead className="bg-gray-50 dark:bg-[#0A0F1F] border-b border-gray-200 dark:border-gray-800">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs text-gray-600 dark:text-gray-400">Created</th>
            ...
            <tbody className="divide-y divide-gray-200 dark:divide-gray-800">
              {disputes.map((dispute) => (
                <tr key={dispute.id} className="hover:bg-gray-50 dark:hover:bg-[#0A0F1F]">
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700 dark:text-gray-300">{dispute.createdDate}</td>
                  <td className="px-6 py-4">
                    <button
