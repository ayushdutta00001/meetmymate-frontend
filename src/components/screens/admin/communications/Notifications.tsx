...
import { Search, Bell, CheckCircle, Circle, Calendar } from 'lucide-react';
import { useNotifications } from '../../../../lib/hooks';
import { LoadingState } from '../../../ui/LoadingState';
import { ErrorState } from '../../../ui/ErrorState';


export function Notifications({ onNavigate }: { onNavigate: (screen: any) => void }) {
 ...
 const handleNotificationClick = async (notif: any) => {
  ...
  if (error) {
    return (
      <div className="p-8">
        ...
        <ErrorState message={error} onRetry={refetch} error={''} />
      </div>
    );
  }
  ...
  !notif.is_read ? "bg-blue-50 dark:bg-blue-500/5" : ""
}`}
