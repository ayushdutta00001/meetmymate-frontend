  ...
  const emailLogs: EmailLog[] = [
    {
      ...
      subject: 'Booking Confirmation - Meet my Mate in',
    ...
    },
    {
      ...
      subject: 'Welcome to Meet my Mate in!',
      templateKey: 'welcome_email',
      status: 'sent',
      htmlContent: '<html><body><h1>Welcome!</h1><p>Thanks for joining Meet my Mate in.</p></body></html>'
    },
  ];
