...
const submitApplication = async () => {
  ...
  onClick={async () => {
    try {
      const res = await api.post('submit_friend_application', {
        user_id: sessionStorage.getItem('user_id'),
        documentType,
        document_path: 'providers/docs/temp', // placeholder
  ...
  className="flex-1 py-4 rounded-xl bg-gradient-to-r from-purple-500 to-pink-600 text-white hover:shadow-xl transition-all"
>
