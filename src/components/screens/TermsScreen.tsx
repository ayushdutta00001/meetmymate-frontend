        ...
        >
          ...
          <div className="mt-8 p-4 bg-yellow-100 dark:bg-yellow-900/20 rounded-2xl">
            ...
            <p className="text-yellow-700 dark:text-yellow-300 text-sm">
              Meet my Mate in is a platform for social connections. We are not responsible for actions taken outside our platform. 
          ...
          <div className="mt-8 p-4 bg-blue-100 dark:bg-blue-900/20 rounded-2xl">
            ...
            <p className="text-blue-700 dark:text-blue-300 text-sm">
              Meet my Mate in is not designed for collecting PII (Personally Identifiable Information) or securing sensitive data. 
