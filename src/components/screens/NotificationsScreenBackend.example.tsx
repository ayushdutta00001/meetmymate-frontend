...
export function NotificationsScreenBackend({ onNavigate, setSelectedMeetingId, onBack }: NotificationsScreenProps) {
  ...
  const handleMarkAllAsRead = async () => {
    await markAllAsReadMutation.mutate(undefined);
    // Refresh notifications list
    refetch();
  };
  ...
  return (
    <div className="min-h-screen bg-[#F2F4F7] dark:bg-[#0A0F1F] pb-24 md:pb-8 md:pr-24">
      ...
      <div className="max-w-4xl mx-auto p-4">
        ...
        {/* Error State */}
        {error && <ErrorState error={error} onRetry={refetch} message={''} />}
