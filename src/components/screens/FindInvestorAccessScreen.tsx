      ...
      <div className="max-w-6xl mx-auto px-6 py-12">
        ...
        >
          <p className="text-sm text-gray-500 dark:text-gray-500 max-w-3xl mx-auto leading-relaxed">
            <strong>Privacy & Security:</strong> Meet My Mate in is designed for professional networking. Do not share sensitive financial data or personal identifying information during initial meetings. All users must comply with our Terms of Service and Community Guidelines.
          </p>
        </motion.div>
      </div>
    </div>
