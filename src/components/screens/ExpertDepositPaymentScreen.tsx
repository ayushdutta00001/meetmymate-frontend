...
interface ExpertDepositPaymentScreenProps {
  onBack: () => void;
  onPaymentComplete: () => void;
  depositAmount: number;
}

export function ExpertDepositPaymentScreen({ onBack, onPaymentComplete, depositAmount }: ExpertDepositPaymentScreenProps) {
    ...
    <div className="min-h-screen bg-[#F2F4F7] dark:bg-[#0A0F1F] pb-24 md:pb-8 md:pr-24">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Refundable deposit for expert verification
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          className="glass dark:glass-dark rounded-2xl p-6 backdrop-blur-xl border border-purple-500/20 bg-purple-500/5 mb-6"
        >
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm mb-1"><strong>Refund Terms</strong></p>
              <ul className="text-xs text-gray-600 dark:text-gray-400 space-y-0.5">
                <li>• Full refund after 6 months of good standing</li>
                <li>• Refundable if you leave the platform</li>
                <li>• Instant refund if application rejected</li>
            ...
            <motion.button
              ...
              className={`w-full p-4 rounded-xl border-2 transition-all text-left ${
                selectedPaymentMethod === 'card'
                  ...
                  : 'border-white/20 dark:border-gray-800/50 glass dark:glass-dark hover:border-purple-500/50'
              }`}
            >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  maxLength={19}
                  className="w-full px-4 py-3 rounded-xl glass dark:glass-dark border-2 border-transparent focus:border-purple-500 dark:focus:border-purple-400 transition-all outline-none text-[#0B0B0C] dark:text-white text-sm"
                />
              </div>
              <div>
                <label className="text-sm text-gray-600 dark:text-gray-400 mb-2 block">
